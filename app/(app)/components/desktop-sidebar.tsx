...
const DesktopSidebar = () => {
  return (
    <aside className="md:fixed left-0 inset-y-0 border-r border-indigo-600 bg-indigo-50 w-76 py-5 px-2 hidden md:block">
      <div className="font-semibold text-indigo-800 flex gap-2 items-center [&>svg]:size-6 px-3 mb-4">
        <svg
          viewBox="0 0 24 24"
          fill="none"
      ...
      <Button
        asChild
        variant="ghost"
        className="w-full justify-start hover:bg-indigo-100"
      >
        <Link href="/dashboard">
          <svg
            width="80"
      ...
      <Button
        asChild
        variant="ghost"
        className="w-full justify-start hover:bg-indigo-100 mt-1"
      >
        <Link href="/dashboard">
          <svg
            viewBox="0 0 25 25"
