const MobileTabBar = () => {
  return (
    <>
      {/* <div className="hidden standalone:block fixed inset-x-0 h-header-inset bg-indigo-50/50 backdrop-blur-md"></div> */}
      <header className="fixed inset-x-0 flex items-center justify-center gap-2 border-b border-indigo-600/20 bg-indigo-50/50 font-semibold text-indigo-800 backdrop-blur-md [&>svg]:h-6 [&>svg]:w-6 md:hidden standalone:pt-header-inset not-standalone:h-16 h-[111px] top-0">
        <svg
          viewBox="0 0 24 24"
          fill="none"
